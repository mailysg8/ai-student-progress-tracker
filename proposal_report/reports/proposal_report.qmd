...
Tutors currently rely on manual processes and human memory to track student progress, which often leads to delayed and unreliable signals for the areas students are struggling with. This makes it difficult for tutors to intervene in a timely manner and provide personalised support to students.
...
Tracking student progress is a persistent challenge in education. Tutors and teachers often rely on manual processes and informal observations to identify students that are struggling, which can lead to delayed interventions and vague feedback. Without timely and reliable signals about which specific areas students are struggling with, it becomes difficult for teachers to provide personalised support.


This problem has led to the development of research in learning analytics, which seeks to use student performance data to gain a clearer understanding of a student's knowledge. Knowledge Tracing is an established method to estimate a student's latent mastery of specific knowledge components over time, based on their observed performance data (@corbett1994knowledge). In recent years, Knowledge Tracing models have been successfully deployed in Intelligent Tutoring Systems which have helped teachers track the progression of their students.
