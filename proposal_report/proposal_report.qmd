...
![This figure shows the number of observations per knowledge component across the dataset. There is a substantial imbalance in coverage, ranging from 25 to 175 observations.](figures/kc_coverage.png){#fig-kc-coverage width=70%}
