...
![KC Coverage Imbalance](figures/kc_coverage.png){#fig-kc-coverage width=70%}
...
![Wide spread within assignments](figures/assignment_spread.png){#fig-assignment-spread width=70%}
...
![Performance band imbalance](figures/performance_band.png){#fig-performance-band width=70%}
...
![Knowledge component relationships](img/kc_graph.png){#fig-kc-graph width=70%}
