...
A student can access their next steps based on their current mastery levels. The prerequisite map shows the student's current mastery for each KC, with arrows indicating which skills are required for others. T
...
the project repository: [GitHub link](https://github.com/mailysg8/ai-student-progress-tracker/tree/main). 